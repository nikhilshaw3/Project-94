...
this.props.navigation.navigate("ImportantTerms");
})
...
<Text style={[styles.signupText,{marginTop: 30}]}> SIGN UP </Text>
...
<Text style ={{fontSize: 40,fontWeight: 'bold'}}>FITNESS GUIDE</Text>
...
style={[styles.loginBox,{marginTop: 180}]}
...
<TouchableOpacity style={[styles.button,{marginBottom: 10,marginTop: 100}]} onPress={() => {
